...
(lib._336x280 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(168.0502,140.0626,1.1202,1.1218);
	...
	this.instance.setTransform(211.1,84.55,0.4431,0.4431,0,0,0,408.7,123.1);
	...
	this.instance_1.setTransform(267.25,246.65,0.7936,0.7937,0,0,0,72.2,17.2);
	...
	this.instance_2.setTransform(69.7,114.7,0.46,0.4597,0,0,0,86.3,77.1);
	...
	this.instance_3.setTransform(72.35,176.5,0.6208,0.6207,0,0,0,68.2,42.9);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(130).to({_off:false},0).to({regY:43,scaleY:0.6208,y:176.55,alpha:1},30).wait(139));

	// T_C
	this.instance_4 = new lib.mc_level3();
	this.instance_4.parent = this;
	this.instance_4.setTransform(70.85,237.25,0.5943,0.5944,0,0,0,68.6,43);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(160).to({_off:false},0).to({regX:0,regY:0,x:30.1,y:211.7,alpha:1},30).wait(109));

	// background_colour
	this.instance_5 = new lib.mc_background();
	this.instance_5.parent = this;
	this.instance_5.setTransform(168,140,1.12,0.4667,0,0,0,150,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regY:299.9,y:-139.95},29,cjs.Ease.quartInOut).wait(270));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(158.6,-139.9,177.50000000000003,420);
// library properties:
lib.properties = {
