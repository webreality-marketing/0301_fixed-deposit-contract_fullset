...
(lib._336x280 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(282.65,79.55,0.4431,0.4431,0,0,0,408.7,123.1);
	...
	this.instance_1.setTransform(168.15,246.65,0.7936,0.7937,0,0,0,72.2,17.2);
	...
	this.instance_2.setTransform(74.75,110.7,0.46,0.4597,0,0,0,86.3,77.1);
	...
	this.instance_3.setTransform(77.4,172.5,0.6208,0.6207,0,0,0,68.2,42.9);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(130).to({_off:false},0).to({regY:43,scaleY:0.6208,y:172.55,alpha:1},30).wait(139));

	// T_C
	this.instance_4 = new lib.mc_level3();
	this.instance_4.parent = this;
	this.instance_4.setTransform(73.5,219.9,0.5606,0.5629,0,0,0,68.5,42.9);
...
p.nominalBounds = new cjs.Rectangle(168,-139.9,168.10000000000002,420);
// library properties:
lib.properties = {
