...
(lib.mc_logo_extended = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#EC0000").s().p("");
	this.shape.setTransform(801.2,71.475);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.mc_logo_extended, new cjs.Rectangle(0,0,1602.4,143), null);
...
(lib.mc_level1_final = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(28).to({_off:false},0).wait(272));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(27).to({_off:false},0).wait(273));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(26).to({_off:false},0).wait(274));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_3).wait(25).to({_off:false},0).wait(275));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_4).wait(24).to({_off:false},0).wait(276));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_5).wait(23).to({_off:false},0).wait(277));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_6).wait(22).to({_off:false},0).wait(278));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_7).wait(21).to({_off:false},0).wait(279));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_8).wait(20).to({_off:false},0).wait(280));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_9).wait(19).to({_off:false},0).wait(281));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_10).wait(18).to({_off:false},0).wait(282));
...
(lib._970x250 = function(mode,startPosition,loop) {
	...
	// border
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#EC0000").ss(2,1,1).p("EgyqgM8MBlVAAAIAAZ5MhlVAAAg");
	this.shape.setTransform(485.0314,124.9964,1.4926,1.4955);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(300));

	// logo_Santander
	this.instance = new lib.mc_logo_extended();
	this.instance.parent = this;
	this.instance.setTransform(230,47.8,0.2496,0.249,0,0,0,801.1,71.5);
	...
	this.instance_1.setTransform(869.7,203.55,0.9792,0.9792,0,0,0,72.2,17.2);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;
	new cjs.ButtonHelper(this.instance_1, 0, 1, 2, false, new lib.primary_cta(), 3);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(161).to({_off:false},0).to({alpha:1},30).wait(109));

	// header
	this.instance_2 = new lib.mc_level1_final();
	this.instance_2.parent = this;
	this.instance_2.setTransform(93.3,133.3,0.7204,0.7199,0,0,0,86.5,77.3);
	...
	this.instance_3.setTransform(106.95,186.9,1.1043,1.1041,0,0,0,68.3,43);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(100).to({_off:false},0).to({scaleY:1.1043,alpha:1},30).wait(170));

	// T_C
	this.instance_4 = new lib.mc_level3();
	this.instance_4.parent = this;
	this.instance_4.setTransform(105.3,244.45,1.086,1.0862,0,0,0,68.3,42.8);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(131).to({_off:false},0).to({alpha:1},30).wait(139));

	// background_colour
	this.instance_5 = new lib.mc_background();
	this.instance_5.parent = this;
	this.instance_5.setTransform(485,125,3.2333,0.4167,0,0,0,150,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regY:299.4,y:-125.1},29,cjs.Ease.quartInOut).wait(271));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(485,-125.1,485.1,375.1);
// library properties:
lib.properties = {
